...
List<Project> projectList = [
  Project(
    'Storo Cloud storage application',
    'Description: Developed a cloud storage application with a simple and easy-to-navigate UI,enabling users to store all types of data.Technologies Used: Flutter, GetX state management, Firebase (Firestore, Auth, Storage), AWSCodeBuild.',
    'assets/images/coffee.png',
    'https://github.com/Hamad-Anwar/Coffe-Shop-Beautifull-UI',
  ),
  Project(
    'Event management system college',
